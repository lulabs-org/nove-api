...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://meeting.tencent.com/marketplace/restApiTool.html?type=jwt-oauth&amp;interface_id=MzluRFd6MW9JblRCMjB2SjRERGFpY3la&amp;replica_id=UHpvWjh2" class="rno-api-explorer-btn" target="_blank"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
|参数名称|参数类型|参数描述|
|---------|---------|---------|
|chapter_list|ChapterList 对象数组|录制文件的智能章节列表。|
...
|chapter_name|String|章节主题，返回 base64 编码后的结果。|
|pic_url|String|章节封面图片 url。|
|start_time|String|章节在视频/音频中开始的时间，单位毫秒。|
