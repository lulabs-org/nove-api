...
export const PERMISSION_CONFIGS: readonly PermissionConfig[] = [
  ...
  {
    name: '查看 MCP Server',
    code: 'mcp-server:read',
    description: '查看 MCP Server 信息',
    resource: 'mcp-server',
    action: 'read',
  },
  {
    name: '创建 MCP Server',
    code: 'mcp-server:create',
    description: '创建新 MCP Server',
    resource: 'mcp-server',
    action: 'create',
  },
  {
    name: '编辑 MCP Server',
    code: 'mcp-server:update',
    description: '编辑 MCP Server 信息',
    resource: 'mcp-server',
    action: 'update',
  },
  {
    name: '删除 MCP Server',
    code: 'mcp-server:delete',
  ...
  {
    name: '停止 MCP Server',
    code: 'mcp-server:stop',
    description: '停止 MCP Server',
    resource: 'mcp-server',
    action: 'stop',
  },
  {
    name: '重启 MCP Server',
    code: 'mcp-server:restart',
    description: '重启 MCP Server',
    resource: 'mcp-server',
    action: 'restart',
  },
  {
    name: 'MCP Server 配置管理',
    code: 'mcp-server:config',
    description: '管理 MCP Server 配置',
    resource: 'mcp-server',
    action: 'config',
  },
  {
    name: '查看 MCP Server 日志',
    code: 'mcp-server:log',
    description: '查看 MCP Server 日志',
    resource: 'mcp-server',
    action: 'log',
  },
  {
    name: 'MCP Server 监控',
    code: 'mcp-server:monitor',
    description: '监控 MCP Server 状态',
    resource: 'mcp-server',
    action: 'monitor',
  },
