...
export const PERMISSION_CONFIGS: readonly PermissionConfig[] = [
  ...
  {
    name: '使用用户搜索工具',
    code: 'mcp-tool:user-search',
    description: '使用 MCP 用户搜索工具',
    resource: 'mcp-tool',
    action: 'user-search',
  },
  {
    name: '使用用户名搜索工具',
    code: 'mcp-tool:username-search',
    description: '使用 MCP 用户名搜索工具',
    resource: 'mcp-tool',
    action: 'username-search',
  },
  {
    name: '使用邮箱搜索工具',
    code: 'mcp-tool:email-search',
    description: '使用 MCP 邮箱搜索工具',
    resource: 'mcp-tool',
    action: 'email-search',
  },
  {
    name: '使用手机号搜索工具',
    code: 'mcp-tool:phone-search',
    description: '使用 MCP 手机号搜索工具',
    resource: 'mcp-tool',
    action: 'phone-search',
  },
  {
    name: '使用综合搜索工具',
    code: 'mcp-tool:combined-search',
    description: '使用 MCP 综合搜索工具',
    resource: 'mcp-tool',
