 ...
 * @LastEditTime: 2026-01-11 16:16:53
 * @FilePath: \nove-api\src\task\service\repositories\period-summary.repository.ts
 * @Description:
 *
...
export class PeriodSummaryRepository {
   ...
   */
  async findSummaryByPlatformUserIds(platformUserIds: string[]) {
